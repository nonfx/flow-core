...
import i_arrow_down_line from "./svg/i-arrow-down-line";
import i_arrow_left from "./svg/i-arrow-left";
import i_arrow_left_line from "./svg/i-arrow-left-line";
import i_arrow_right from "./svg/i-arrow-right";
import i_arrow_right_line from "./svg/i-arrow-right-line";
...
import i_arrow_up_line from "./svg/i-arrow-up-line";
...
import i_bulk_edit_line from "./svg/i-bulk-edit-line";
...
import i_category from "./svg/i-category";
import i_category_1 from "./svg/i-category-1";
import i_category_1_line from "./svg/i-category-1-line";
import i_change from "./svg/i-change";
...
import i_chevron_down_line from "./svg/i-chevron-down-line";
import i_chevron_left from "./svg/i-chevron-left";
import i_chevron_left_line from "./svg/i-chevron-left-line";
import i_chevron_right from "./svg/i-chevron-right";
import i_chevron_right_line from "./svg/i-chevron-right-line";
import i_chevron_up from "./svg/i-chevron-up";
import i_chevron_up_line from "./svg/i-chevron-up-line";
...
import i_clause_line from "./svg/i-clause-line";
...
import i_compare_1 from "./svg/i-compare-1";
...
import i_customer_support_line from "./svg/i-customer-support-line";
...
import i_dashboard_line from "./svg/i-dashboard-line";
...
import i_design_line from "./svg/i-design-line";
import i_device_mobile from "./svg/i-device-mobile";
import i_direct_match from "./svg/i-direct-match";
import i_direct_match_line from "./svg/i-direct-match-line";
import i_distributed_match from "./svg/i-distributed-match";
import i_distributed_match_line from "./svg/i-distributed-match-line";
...
import i_document_edit from "./svg/i-document-edit";
import i_document_line from "./svg/i-document-line";
...
import i_domain from "./svg/i-domain";
import i_dots_vertical from "./svg/i-dots-vertical";
import i_download from "./svg/i-download";
import i_download_line from "./svg/i-download-line";
import i_draft from "./svg/i-draft";
...
import i_edit_line from "./svg/i-edit-line";
...
import i_evidence_approved_line from "./svg/i-evidence-approved-line";
import i_evidence_line from "./svg/i-evidence-line";
import i_evidence_missing from "./svg/i-evidence-missing";
import i_evidence_missing_line from "./svg/i-evidence-missing-line";
import i_evidence_no from "./svg/i-evidence-no";
import i_evidence_no_line from "./svg/i-evidence-no-line";
import i_evidence_rejected from "./svg/i-evidence-rejected";
import i_evidence_rejected_line from "./svg/i-evidence-rejected-line";
...
import i_file_download from "./svg/i-file-download";
import i_file_missing from "./svg/i-file-missing";
import i_file_upload from "./svg/i-file-upload";
import i_filter from "./svg/i-filter";
import i_filter_line from "./svg/i-filter-line";
...
import i_folder_logical_line from "./svg/i-folder-logical-line";
...
import i_generic_line from "./svg/i-generic-line";
...
import i_home_line from "./svg/i-home-line";
import i_icon from "./svg/i-icon";
import i_id from "./svg/i-id";
...
import i_library from "./svg/i-library";
import i_library_3 from "./svg/i-library-3";
...
import i_more_line from "./svg/i-more-line";
import i_name from "./svg/i-name";
import i_network from "./svg/i-network";
import i_no_evidence_line from "./svg/i-no-evidence-line";
...
import i_phase from "./svg/i-phase";
import i_phase_line from "./svg/i-phase-line";
import i_photo from "./svg/i-photo";
import i_pin from "./svg/i-pin";
import i_platform_line from "./svg/i-platform-line";
...
import i_playlist_add_line from "./svg/i-playlist-add-line";
import i_playlist_edit from "./svg/i-playlist-edit";
import i_playlist_edit_line from "./svg/i-playlist-edit-line";
import i_playlist_line from "./svg/i-playlist-line";
...
import i_plus_line from "./svg/i-plus-line";
import i_plus_sm from "./svg/i-plus-sm";
import i_policy_line from "./svg/i-policy-line";
...
import i_priority_neutral from "./svg/i-priority-neutral";
import i_privacy_management from "./svg/i-privacy-management";
import i_process from "./svg/i-process";
import i_process_line from "./svg/i-process-line";
import i_processing_type from "./svg/i-processing-type";
import i_prod from "./svg/i-prod";
import i_production_line from "./svg/i-production-line";
import i_publisher from "./svg/i-publisher";
...
import i_security from "./svg/i-security";
import i_selector from "./svg/i-selector";
import i_send_line from "./svg/i-send-line";
import i_separator from "./svg/i-separator";
import i_server from "./svg/i-server";
import i_setting from "./svg/i-setting";
import i_settings_line from "./svg/i-settings-line";
import i_share_2 from "./svg/i-share-2";
import i_share_line from "./svg/i-share-line";
import i_shield from "./svg/i-shield";
import i_shield_alert from "./svg/i-shield-alert";
import i_shield_lock from "./svg/i-shield-lock";
import i_shield_lock_line from "./svg/i-shield-lock-line";
...
import i_software from "./svg/i-software";
...
import i_table_view_line from "./svg/i-table-view-line";
...
import i_tick_fill_line from "./svg/i-tick-fill-line";
import i_tick_line from "./svg/i-tick-line";
...
import i_trim_line from "./svg/i-trim-line";
import i_two_col from "./svg/i-two-col";
import i_two_col_line from "./svg/i-two-col-line";
...
const IconPack = {
	...
	"i-arrow-down-line": i_arrow_down_line,
	"i-arrow-down": i_arrow_down,
	"i-arrow-left-line": i_arrow_left_line,
	"i-arrow-left": i_arrow_left,
	"i-arrow-right-line": i_arrow_right_line,
	...
	"i-arrow-up-line": i_arrow_up_line,
	...
	"i-bug": i_bug,
	"i-bulb": i_bulb,
	"i-bulk-edit-line": i_bulk_edit_line,
	"i-calculator": i_calculator,
	"i-calendar-line": i_calendar_line,
	...
	"i-cart": i_cart,
	"i-catalog": i_catalog,
	"i-category-1-line": i_category_1_line,
	"i-category-1": i_category_1,
	...
	"i-chat": i_chat,
	"i-chevron-down-line": i_chevron_down_line,
	"i-chevron-down": i_chevron_down,
	"i-chevron-left-line": i_chevron_left_line,
	"i-chevron-left": i_chevron_left,
	"i-chevron-right-line": i_chevron_right_line,
	"i-chevron-right": i_chevron_right,
	"i-chevron-up-line": i_chevron_up_line,
	...
	"i-column": i_column,
	"i-compare-1-line": i_compare_1_line,
	"i-compare-1": i_compare_1,
	"i-compare": i_compare,
	...
	"i-customer-support-line": i_customer_support_line,
	"i-customer-support": i_customer_support,
	"i-cut": i_cut,
	"i-dash-grid": i_dash_grid,
	"i-dash-list": i_dash_list,
	"i-dash": i_dash,
	"i-dashboard-line": i_dashboard_line,
	...
	"i-design-line": i_design_line,
	"i-device-mobile": i_device_mobile,
	"i-direct-match-line": i_direct_match_line,
	"i-direct-match": i_direct_match,
	"i-distributed-match-line": i_distributed_match_line,
	...
	"i-document-edit": i_document_edit,
	"i-document-line": i_document_line,
	...
	"i-download-line": i_download_line,
	...
	"i-evidence-approved-line": i_evidence_approved_line,
	"i-evidence-approved": i_evidence_approved,
	"i-evidence-line": i_evidence_line,
	"i-evidence-missing-line": i_evidence_missing_line,
	"i-evidence-missing": i_evidence_missing,
	"i-evidence-no-line": i_evidence_no_line,
	"i-evidence-no": i_evidence_no,
	"i-evidence-rejected-line": i_evidence_rejected_line,
	...
	"i-file-download": i_file_download,
	"i-file-missing": i_file_missing,
	"i-file-upload": i_file_upload,
	"i-file": i_file,
	"i-filter-line": i_filter_line,
	"i-filter": i_filter,
	...
	"i-folder-logical-line": i_folder_logical_line,
	...
	"i-launch": i_launch,
	"i-letter": i_letter,
	"i-library-3": i_library_3,
	"i-library-fill": i_library_fill,
	"i-library-line": i_library_line,
	"i-library": i_library,
	"i-line": i_line,
	"i-link": i_link,
	"i-loader": i_loader,
	...
	"i-missing-evidence": i_missing_evidence,
	"i-more-filled": i_more_filled,
	"i-more-line": i_more_line,
	"i-more": i_more,
	"i-name": i_name,
	"i-network": i_network,
	"i-no-evidence-line": i_no_evidence_line,
	"i-no-logo": i_no_logo,
	...
	"i-phase-line": i_phase_line,
	"i-phase": i_phase,
	"i-photo": i_photo,
	"i-pin": i_pin,
	"i-platform-line": i_platform_line,
	"i-play-fill": i_play_fill,
	"i-play-stop": i_play_stop,
	"i-play": i_play,
	"i-playlist-add-line": i_playlist_add_line,
	"i-playlist-add": i_playlist_add,
	"i-playlist-edit-line": i_playlist_edit_line,
	...
	"i-plus-line": i_plus_line,
	"i-plus-sm": i_plus_sm,
	"i-plus": i_plus,
	"i-policy-line": i_policy_line,
	...
	"i-priority-medium": i_priority_medium,
	"i-priority-neutral": i_priority_neutral,
	"i-priority": i_priority,
	"i-privacy-management": i_privacy_management,
	"i-process-line": i_process_line,
	"i-process": i_process,
	"i-processing-type": i_processing_type,
	"i-prod": i_prod,
	"i-production-line": i_production_line,
	"i-publisher": i_publisher,
	"i-puzzle": i_puzzle,
	"i-qrcode": i_qrcode,
	...
	"i-search": i_search,
	"i-security": i_security,
	"i-selector": i_selector,
	"i-send-line": i_send_line,
	"i-separator": i_separator,
	"i-server": i_server,
	"i-setting": i_setting,
	"i-settings-line": i_settings_line,
	"i-share-2": i_share_2,
	"i-share-line": i_share_line,
	"i-shield-alert": i_shield_alert,
	"i-shield-lock-line": i_shield_lock_line,
	"i-shield-lock": i_shield_lock,
	"i-shield-success": i_shield_success,
	"i-shield": i_shield,
	"i-shopping-bag": i_shopping_bag,
	"i-shrink": i_shrink,
	"i-software": i_software,
	...
	"i-sub-clause-line": i_sub_clause_line,
	...
	"i-table-view-line": i_table_view_line,
	"i-table": i_table,
	"i-tag": i_tag,
	...
	"i-tick-fill-line": i_tick_fill_line,
	"i-tick-fill": i_tick_fill,
	"i-tick-line": i_tick_line,
	...
	"i-trim-line": i_trim_line,
	"i-two-col-line": i_two_col_line,
	"i-two-col": i_two_col,
	"i-type": i_type,
	"i-unlink": i_unlink,
	"i-unlock": i_unlock,
