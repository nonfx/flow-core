...
import p_ruby_on_rails from "./svg/p-ruby-on-rails";
import p_nodejs from "./svg/p-nodejs";
import p_elasticsearch from "./svg/p-elasticsearch";
import p_apache_spark from "./svg/p-apache-spark";
import p_ngnix from "./svg/p-ngnix";
import p_lightspeed from "./svg/p-lightspeed";
import p_vscode from "./svg/p-vscode";
import p_django from "./svg/p-django";
import p_apache from "./svg/p-apache";
import p_jenkins from "./svg/p-jenkins";
...
import p_wordpress from "./svg/p-wordpress";
import p_grafana from "./svg/p-grafana";
...
import p_starchitect_mark_dark from "./svg/p-starchitect-mark-dark";
...
import p_starchitect_full_light_app from "./svg/p-starchitect-full-light-app";
import p_starchitect_mark_light from "./svg/p-starchitect-mark-light";
...
const IconPack = {
	...
	"p-jupyter": p_jupyter,
	"p-dataiku": p_dataiku,
	"p-ruby-on-rails": p_ruby_on_rails,
	"p-nodejs": p_nodejs,
	"p-elasticsearch": p_elasticsearch,
	"p-apache-spark": p_apache_spark,
	"p-ngnix": p_ngnix,
	"p-lightspeed": p_lightspeed,
	"p-vscode": p_vscode,
	"p-django": p_django,
	"p-apache": p_apache,
	"p-jenkins": p_jenkins,
	...
	"p-starchitect-mark-light": p_starchitect_mark_light,
	"p-starchitect-full-dark": p_starchitect_full_dark,
	"p-starchitect-full-light": p_starchitect_full_light
