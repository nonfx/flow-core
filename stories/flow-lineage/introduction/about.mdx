...
If you have an existing front-end project, you need to install [Flow core](https://github.com/nonfx/flow-core) into that project before continuing with Flow lineage.
If you do not have an existing front-end project, you can easily create one from a [flow starter kit](https://github.com/nonfx/flow-core#starter-kits).
