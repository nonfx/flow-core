import{x as A,o as D}from"./iframe-BdnCiKt2.js";const F=`<svg width="576" height="48" viewBox="0 0 576 48" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
`,k={title:"@nonfx/flow-core/f-divider",parameters:{controls:{hideNoControlsWarning:!0}}},i={render:e=>A`<f-div direction="column" padding="x-large"
  ...
  name: "state"
}`,...(B=(S=r.parameters)==null?void 0:S.docs)==null?void 0:B.source}}};const U=["Playground","Anatomy","Specifications","Variant","Size","State"],C=Object.freeze(Object.defineProperty({__proto__:null,Anatomy:n,Playground:i,Size:t,Specifications:d,State:r,Variant:a,__namedExportsOrder:U,default:k},Symbol.toStringTag,{value:"Module"}));export{n as A,C as F,i as P,d as S,a as V,t as a,r as b};
