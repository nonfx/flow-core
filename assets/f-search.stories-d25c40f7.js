import{x as s}from"./lit-html-57bab4fd.js";const oe={title:"@nonfx/flow-core/f-search",parameters:{controls:{hideNoControlsWarning:!0}}},g={render:e=>{const i=t=>{console.log(t.detail)},n=t=>{console.log(t.detail)};return s`
            <f-div padding="large">
                <f-search
