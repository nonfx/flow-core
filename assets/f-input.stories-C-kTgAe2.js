import{x as i,o as me}from"./iframe-BdnCiKt2.js";import{f as ve}from"./i-finput-anatomy-DZtGO_DG.js";const{useState:d}=__STORYBOOK_MODULE_PREVIEW_API__,ge={title:"@nonfx/flow-core/f-input",parameters:{controls:{hideNoControlsWarning:!0}}},s={render:e=>{const a=l=>{console.log(l.detail)};return i`
            <f-div width="100%" align="middle-center" padding="large">
                ...
                ></f-div
            >
        `},name:"Playground",argTypes:{value:{control:"text"},placeholder:{control:"text"},variant:{control:"select",options:["curved","round","block"]},category:{control:"select",options:["fill","transparent","outline"]},type:{control:"select",options:["text","number","email","password","url","tel"]},state:{control:"select",options:["default","success","primary","warning","danger"]},size:{control:"radio",options:["small","medium"]},"icon-left":{control:"text"},"icon-right":{control:"text"},prefix:{control:"text"},suffix:{control:"text"},loading:{control:"boolean"},disabled:{control:"boolean"},readOnly:{control:"boolean"},clear:{control:"boolean"},"max-length":{control:"text"}},args:{value:null,placeholder:"Enter your text here",variant:"round",category:"fill",type:"text",state:"default",size:"medium","icon-left":void 0,"icon-right":void 0,prefix:void 0,suffix:void 0,"max-length":void 0,loading:!1,disabled:!1,readOnly:!1,clear:!1}},o={render:()=>i`<div class="align-center">${me(ve)}</div>`,name:"Anatomy"},u={render:()=>{const e=["curved","round","block"],[a,l]=d(""),t=n=>{l(n.detail.value)};return i`
      ...
      >`)}
        ...
        `},name:"Flags"};var y,T,S;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
...
}`,...(S=(T=s.parameters)==null?void 0:T.docs)==null?void 0:S.source}}};var w,L,H;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:'{\n  render: () => html`<div class="align-center">${unsafeSVG(fInputAnatomy)}</div>`,\n  name: "Anatomy"\n}',...(H=(L=o.parameters)==null?void 0:L.docs)==null?void 0:H.source}}};var W,C,E;u.parameters={...u.parameters,docs:{...(W=u.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "suffix"
}`,...(re=(de=b.parameters)==null?void 0:de.docs)==null?void 0:re.source}}};var se,oe,ue;V.parameters={...V.parameters,docs:{...(se=V.parameters)==null?void 0:se.docs,source:{originalSource:`{
  render: () => {
    const [value, setValue] = useState("");
    const handleValue = (e: CustomEvent) => {
      setValue(e.detail.value);
  ...
  name: "max-length"
}`,...(ue=(oe=V.parameters)==null?void 0:oe.docs)==null?void 0:ue.source}}};var pe,fe,ce;z.parameters={...z.parameters,docs:{...(pe=z.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  render: () => {
    const [value, setValue] = useState("");
    const handleValue = (e: CustomEvent) => {
      setValue(e.detail.value);
  ...
  name: "Flags"
}`,...(ce=(fe=z.parameters)==null?void 0:fe.docs)==null?void 0:ce.source}}};const he=["Playground","Anatomy","Variant","Category","Type","Value","Placeholder","Size","State","IconLeft","IconRight","Prefix","Suffix","MaxLength","Flags"],be=Object.freeze(Object.defineProperty({__proto__:null,Anatomy:o,Category:p,Flags:z,IconLeft:h,IconRight:x,MaxLength:V,Placeholder:m,Playground:s,Prefix:$,Size:v,State:g,Suffix:b,Type:f,Value:c,Variant:u,__namedExportsOrder:he,default:ge},Symbol.toStringTag,{value:"Module"}));export{o as A,p as C,be as F,h as I,V as M,s as P,v as S,f as T,u as V,c as a,m as b,g as c,x as d,$ as e,b as f,z as g};
