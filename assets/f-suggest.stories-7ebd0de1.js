import{x as i}from"./lit-html-57bab4fd.js";import{f as Se}from"./i-finput-anatomy-08dacfc4.js";import{o as fe}from"./unsafe-svg-0091c80b.js";const pe={title:"@nonfx/flow-core/f-suggest",parameters:{controls:{hideNoControlsWarning:!0}}},s={render:e=>{const g=t=>{console.log(t.detail.value)},n=t=>{t.stopPropagation(),t.stopImmediatePropagation()};return i`
      ...
      >`)}
        ...
        `},name:"variant"},l={render:()=>{const e=["fill","outline","transparent"],g="",n=t=>{console.log(t.detail.value)};return i`
            <f-div width="100%" align="middle-center" padding="large" gap="medium">
                ${e.map(t=>i`<f-div>
          <f-suggest
            value=${g}
      ...
      >`)}
        ...
        `,name:"value"},r={render:()=>i`
            <f-div width="100%" align="middle-center" padding="large">
                ...
                ></f-div
            >
        `,name:"placeholder"},d={render:()=>{const e=["small","medium"],g="",n=t=>{console.log(t.detail.value)};return i`
      ...
      >`)}
        ...
        `},name:"size"},S={render:()=>{const e=[["default","primary","success"],["danger","warning","default"]],g="",n=t=>{console.log(t.detail.value)};return i`
        ...
        `},name:"state"},f={render:()=>{const e="",g=t=>{console.log(t.detail.value)};return i`
            <f-div width="100%" align="middle-center" padding="large" gap="medium">
        ...
        `,name:"suffix"},h={render:()=>i`
            <f-div width="100%" align="middle-center" padding="large">
                ...
                ></f-div
            >
        `,name:"max-length"},x={render:()=>{const e="",g=n=>{console.log(n.detail.value)};return i`
            <f-div width="100%" align="top-center" padding="large" gap="medium">
  ...
  name: "value"
}`,...(O=(I=u.parameters)==null?void 0:I.docs)==null?void 0:O.source}}};var D,k,A;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => {
    const value = "";
    const handleValue = (e: CustomEvent) => {
      console.log(e.detail.value);
  ...
  name: "placeholder"
}`,...(A=(k=r.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};var _,F,M;d.parameters={...d.parameters,docs:{...(_=d.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "size"
}`,...(M=(F=d.parameters)==null?void 0:F.docs)==null?void 0:M.source}}};var R,K,N;S.parameters={...S.parameters,docs:{...(R=S.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "icon-right"
}`,...(Z=(Y=c.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,ne,te;m.parameters={...m.parameters,docs:{...(ee=m.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => {
    const value = "";
    const handleValue = (e: CustomEvent) => {
      console.log(e.detail.value);
  ...
  name: "prefix"
}`,...(te=(ne=m.parameters)==null?void 0:ne.docs)==null?void 0:te.source}}};var ie,ge,se;v.parameters={...v.parameters,docs:{...(ie=v.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => {
    const value = "";
    const handleValue = (e: CustomEvent) => {
      console.log(e.detail.value);
  ...
  name: "suffix"
}`,...(se=(ge=v.parameters)==null?void 0:ge.docs)==null?void 0:se.source}}};var oe,ae,le;h.parameters={...h.parameters,docs:{...(oe=h.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => {
    const value = "";
    const handleValue = (e: CustomEvent) => {
      console.log(e.detail.value);
  ...
  name: "max-length"
}`,...(le=(ae=h.parameters)==null?void 0:ae.docs)==null?void 0:le.source}}};var ue,re,de;x.parameters={...x.parameters,docs:{...(ue=x.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  render: () => {
    const value = "";
    const handleValue = (e: CustomEvent) => {
      console.log(e.detail.value);
  ...
  name: "Flags"
}`,...(de=(re=x.parameters)==null?void 0:re.docs)==null?void 0:de.source}}};const ce=["Playground","Anatomy","Variant","Category","Value","Placeholder","Size","State","Suggestions","IconLeft","IconRight","Prefix","Suffix","MaxLength","Flags"],xe=Object.freeze(Object.defineProperty({__proto__:null,Anatomy:o,Category:l,Flags:x,IconLeft:p,IconRight:c,MaxLength:h,Placeholder:r,Playground:s,Prefix:m,Size:d,State:S,Suffix:v,Suggestions:f,Value:u,Variant:a,__namedExportsOrder:ce,default:pe},Symbol.toStringTag,{value:"Module"}));export{o as A,l as C,xe as F,p as I,h as M,s as P,d as S,a as V,u as a,r as b,S as c,f as d,c as e,m as f,v as g,x as h};
