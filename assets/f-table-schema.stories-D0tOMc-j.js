import{e as o,x as a,n as s}from"./iframe-CCyKNv7C.js";import{f as i}from"./chunk-KZPPZA2C-BtqgzDBU.js";const c=o();function O(){return i.string.alpha(10)}function n(e=100,t=8){const d=[];for(let f=0;f<e;f++){const F={value:i.person.firstName(),align:"middle-left",template:function(){return a`<f-div gap="small" align="middle-left" width="100%" height="100%">
				...
				>`},actions:[{icon:"i-chat",tooltip:"This is Tooltip",id:O(),onClick(Ye,B){c.value&&(c.value.open=!0,B&&(c.value.target=B))}},{icon:"i-mail",tooltip:"This is 2nd Tooltip",id:O()},{icon:"i-star",tooltip:"This is 3rd Tooltip",id:O()}]},ze={value:i.phone.number()},Ie={value:i.person.sex()},Le={value:i.number.int({min:18,max:60})},je={value:i.date.birthdate({min:18,max:65,mode:"age"}),template:function(){return a`<f-div gap="small" width="hug-content">
					<f-icon source="i-date-time"></f-icon>
					<f-text inline
						>${this.value.getDate()}-${this.value.getMonth()}-${this.value.getFullYear()}</f-text
					></f-div
				>`},toString:function(){return this.value.toString()}},_e={value:`${i.location.street()}, ${i.location.city()}, ${i.location.state()}, ${i.location.zipCode()} ${i.location.country()}`},Me={id:O(),disableSelection:f%2===0,expandIconPosition:"right",data:{firstName:F,lastName:l,age:Le,birthDate:je,email:Pe,mobile:ze,sex:Ie,address:_e},details:function(){return a`<f-div padding="large"
				...
				>`}},lastName:{value:"Last name"},age:{value:"Age"},birthDate:{value:"Birth Date"},mobile:{value:"Mobile"},email:{value:"Email"},sex:{value:"Sex",disableSort:!0},address:{value:"Address",width:"300px",selected:!1,sticky:!0}}).slice(0,t)),rows:d}}const Ae={title:"@nonfx/flow-table/f-table-schema",parameters:{controls:{hideNoControlsWarning:!0}}},m={render:e=>{const t=()=>{console.log("in next event")},d=l=>{console.log("on row toggled",l.detail)},r=l=>{console.log("on row input",l.detail)},f=l=>{console.log("on header selected",l.detail)},F=()=>{c.value&&(c.value.open=!1)};return a`
            <f-popover ${s(c)} @overlay-click=${F}>
        ...
        `},name:"sort-order"},x={render:()=>{const e=n(10);return a`
            <f-div gap="small" height="100%" overflow="scroll" gap="auto" width="100%">
                <f-div direction="column" gap="medium" overflow="hidden">
        ...
        `},name:"search-term"},y={render:()=>{const e=n(10,5);return a`
            <f-div gap="small" height="100%" overflow="scroll" gap="auto" width="100%">
                <f-div direction="column" gap="medium" overflow="hidden">
        ...
        `},name:"show-scrollbar"},k={render:()=>{const e=n(10,5),t=o();return a`<f-div direction="column" state="subtle" padding="small" gap="large">
            ...
            <pre ${s(t)}></pre> `},name:"@toggle-row-details"},S={render:()=>{const e=n(10,5),t=o();return a`<f-div direction="column" state="subtle" padding="small" gap="large">
                <f-text
            ...
            <br />
            <f-text state="secondary">'event.detail' will display here</f-text>
            <pre ${s(t)}></pre> `},name:"@row-input"},R={render:()=>{const e=n(10,5),t=o();return a`<f-div direction="column" state="subtle" padding="small" gap="large">
                <f-text
            ...
            <br />
            <f-text state="secondary">'event.detail' will display here</f-text>
            <pre ${s(t)}></pre> `},name:"@header-selected"},C={render:()=>{const e=n(10,5),t=o();return a`<f-div direction="column" state="subtle" padding="small" gap="large">
                <f-text
            ...
            <br />
            <f-text state="secondary">'event.detail' will display here</f-text>
            <pre ${s(t)}></pre> `},name:"@header-input"},N={render:()=>{const e=n(50,5),t=o();return a`<f-div direction="column" state="subtle" padding="small" gap="large" height="50%">
            ...
            <br />
            <f-text state="secondary">'event.detail' will display here</f-text>
            <pre ${s(t)}></pre> `},name:"@sort"},E={render:()=>{const e=n(50,5),t=o();return a`<f-div direction="column" state="subtle" padding="small" gap="large" height="50%">
                <f-text
            ...
            <br />
            <f-text state="secondary">'event.detail' will display here</f-text>
            <pre ${s(t)}></pre> `},name:"@next"},H={render:()=>{const e=n(50,5),t=o();return a`<f-div direction="column" state="subtle" padding="small" gap="large" height="50%">
            ...
            <br />
            <f-text state="secondary">'event.detail' will display here</f-text>
            <pre ${s(t)}></pre> `},name:"@row-click"},T={render:()=>{const e=n(0,5);return a`<f-div direction="column" padding="small" gap="large" height="50%">
  ...
  name: "sort-order"
}`,...(ne=(ae=w.parameters)==null?void 0:ae.docs)==null?void 0:ne.source}}};var re,ie,de;x.parameters={...x.parameters,docs:{...(re=x.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "search-term"
}`,...(de=(ie=x.parameters)==null?void 0:ie.docs)==null?void 0:de.source}}};var oe,se,le;y.parameters={...y.parameters,docs:{...(oe=y.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => {
    const data = getFakeUsers(10, 5);
    return html\`
            <f-div gap="small" height="100%" overflow="scroll" gap="auto" width="100%">
...
}`,...(le=(se=y.parameters)==null?void 0:se.docs)==null?void 0:le.source}}};var ce,fe,me;$.parameters={...$.parameters,docs:{...(ce=$.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "@row-input"
}`,...(be=(ge=S.parameters)==null?void 0:ge.docs)==null?void 0:be.source}}};var we,xe,ye;R.parameters={...R.parameters,docs:{...(we=R.parameters)==null?void 0:we.docs,source:{originalSource:`{
  render: () => {
    const data = getFakeUsers(10, 5);
    const fieldRef = createRef();
    const handleEvent = (event: CustomEvent) => {
...
}`,...(ye=(xe=R.parameters)==null?void 0:xe.docs)==null?void 0:ye.source}}};var $e,ke,Se;C.parameters={...C.parameters,docs:{...($e=C.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  render: () => {
    const data = getFakeUsers(10, 5);
    const fieldRef = createRef();
    const handleEvent = (event: CustomEvent) => {
  ...
  name: "slot='no-data'"
}`,...(De=(Je=T.parameters)==null?void 0:Je.docs)==null?void 0:De.source}}};const We=["Playground","Data","HeaderCellTemplate","StickyHeader","StickyCellBackground","RowsPerPage","SortBy","SortOrder","SearchTerm","ShowSearchBar","ShowScrollBar","ToggleRowDetails","RowInput","HeaderSelected","HeaderInput","Sort","Next","RowClick","NoData"],Ke=Object.freeze(Object.defineProperty({__proto__:null,Data:h,HeaderCellTemplate:v,HeaderInput:C,HeaderSelected:R,Next:E,NoData:T,Playground:m,RowClick:H,RowInput:S,RowsPerPage:g,SearchTerm:x,ShowScrollBar:$,ShowSearchBar:y,Sort:N,SortBy:b,SortOrder:w,StickyCellBackground:p,StickyHeader:u,ToggleRowDetails:k,__namedExportsOrder:We,default:Ae},Symbol.toStringTag,{value:"Module"}));export{Ke as F,m as P};
