import{x as i}from"./iframe-BdnCiKt2.js";const I={title:"@nonfx/flow-core/f-text",parameters:{controls:{hideNoControlsWarning:!0}}},t={render:e=>{const N=D=>{console.log("story edited",D.detail.value)};return i`<f-div direction="column" gap="large">
            <f-text
                .variant=${e.variant}
                .size=${e.size}
                .state=${e.state}
