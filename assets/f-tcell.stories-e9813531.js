import{x as e}from"./lit-html-b1a28dc3.js";import{n as P,e as T}from"./ref-a55570ea.js";const j={title:"@nonfx/flow-table/f-tcell",parameters:{controls:{hideNoControlsWarning:!0}}},r={render:t=>e`
            <f-table>
                <f-trow slot="header">
        ...
        `,name:"Playground",argTypes:{actions:{control:"object"},selected:{control:{type:"boolean"}}},args:{actions:[{icon:"i-copy",onClick:()=>console.log("i-launch clicked")},{icon:"i-git-branch",onClick:()=>console.log("i-launch clicked")},{icon:"i-launch",onClick:()=>console.log("i-launch clicked")}],selected:!1}},o={render:()=>e`<f-div align="middle-center" padding="large">Display anatomy here</f-div>`,name:"Anatomy"},a={render:()=>e`<f-div direction="column" state="subtle" padding="small" gap="large">
...
}`,...(u=(m=r.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};var g,p,h;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => html\`<f-div align="middle-center" padding="large">Display anatomy here</f-div>\`,
  name: "Anatomy"
}`,...(h=(p=o.parameters)==null?void 0:p.docs)==null?void 0:h.source}}};var $,b,v;a.parameters={...a.parameters,docs:{...($=a.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...
  name: "actions"
}`,...(v=(b=a.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var w,x,C;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => html\`<f-div direction="column" state="subtle" padding="small" gap="large"
...
}`,...(_=(O=d.parameters)==null?void 0:O.docs)==null?void 0:_.source}}};const J=["Playground","Anatomy","Actions","Selected","Align","HighlightColumn","SelectedColumn"],D=Object.freeze(Object.defineProperty({__proto__:null,Actions:a,Align:i,Anatomy:o,HighlightColumn:f,Playground:r,Selected:c,SelectedColumn:d,__namedExportsOrder:J,default:j},Symbol.toStringTag,{value:"Module"}));export{o as A,D as F,f as H,r as P,c as S,a,d as b};
