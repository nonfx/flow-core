import{x as i,e as g,n as u}from"./iframe-D6om2Bsl.js";const p={title:"@nonfx/flow-lineage/f-lineage",parameters:{controls:{hideNoControlsWarning:!0}}},l=g(),h=e=>{const n=document.querySelector("#lineage-tooltip");n&&(n.innerHTML=e)},a={render:e=>{const n=t=>{console.log("Got ready event",t)},c=t=>{var o,r,d;t.detail.node.fNodeMeta,console.log(t==null?void 0:t.detail),(o=t.detail.node.fNodeMeta)!=null&&o.tabSections&&(Object.keys((r=t.detail.node.fNodeMeta)==null?void 0:r.tabSections),(d=t.detail.node.fNodeMeta)==null||d.tabSections)};return i`<f-div id="can-fullscreen" ${u(l)} height="100%">
...
}`,...(f=(m=a.parameters)==null?void 0:m.docs)==null?void 0:f.source}}};const v=["Playground"],b=Object.freeze(Object.defineProperty({__proto__:null,Playground:a,__namedExportsOrder:v,default:p},Symbol.toStringTag,{value:"Module"}));export{b as F,a as P};
