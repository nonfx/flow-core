import{x as i}from"./lit-html-57bab4fd.js";const $={title:"@nonfx/flow-lineage/Examples",parameters:{controls:{hideNoControlsWarning:!0}}},t={render:g=>{const o={user:{fData:{icon:"i-user",state:"neutral"}},computer:{fData:{icon:"i-computer",state:"primary",effect:"pulse"}},failed:{fData:{icon:"i-org-fill",state:"danger"}},result:{fData:{icon:"i-crown",state:"neutral"}}},u=[{from:"user",to:"computer"},{from:"user",to:"failed"},{from:"failed",to:"result"},{from:"computer",to:"result"},{from:"user",to:"result"}],d=e=>{var a,r,s;return i`<f-icon-button
  ...
  height: "500px"
}`,...(l=(f=t.parameters)==null?void 0:f.docs)==null?void 0:l.source}}};const h=["Playground"];export{t as Playground,h as __namedExportsOrder,$ as default};
