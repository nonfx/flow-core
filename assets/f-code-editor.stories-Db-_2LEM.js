import{x as o}from"./iframe-BdnCiKt2.js";const{useArgs:M,useState:l}=__STORYBOOK_MODULE_PREVIEW_API__,W={title:"@nonfx/flow-code-editor/f-code-editor",parameters:{controls:{hideNoControlsWarning:!0}}},d={render:e=>{const[n,t]=M(),r=function(a){console.log(a)};return o`<f-div padding="x-large" height="100%">
            <f-code-editor
                .code=${e.code}
                .language=${e.language}
                .state=${e.state}
...
}  `,language:"scala"}},c={render:e=>{const[n,t]=l("");return o`
...
}  `,language:"scala"}},i={render:e=>{const[n,t]=l(!0);return o`
            <f-div padding="x-large" height="100%" gap="x-large" direction="column">
...
}`,language:"javascript"}},u={render:e=>{const[n,t]=l(!0);return o`
            <f-div padding="x-large" height="100%" gap="x-large" direction="column">
                <f-div height="hug-content">
                    <f-switch .value=${n} @input=${a=>{t(a.detail.value)}}>
...
function add(a, b) {
  // This function adds two numbers
  return a + b; // Return the sum
}`,language:"javascript"}},g={render:e=>{const[n,t]=l(!0);return o`
            <f-div padding="x-large" height="100%" gap="x-large" direction="column">
                <f-div height="hug-content">
                    <f-switch .value=${n} @input=${a=>{t(a.detail.value)}}>
...
function add(a, b) {
  // This function adds two numbers
  return a + b; // Return the sum
}`,language:"javascript"}},f={render:e=>{const[n,t]=l("default");return o`
            <f-div padding="x-large" height="100%" gap="x-large" direction="column">
                <f-div width="200px" height="hug-content">
...
}  `,language:"scala"}},p={render:e=>{const[n,t]=l(!1);return o`
            <f-div padding="x-large" height="100%" gap="x-large" direction="column">
                <f-div height="hug-content">
                    <f-switch .value=${n} @input=${a=>{t(a.detail.value)}}>
...
}`,...(j=(C=u.parameters)==null?void 0:C.docs)==null?void 0:j.source}}};var P,E,N;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: args => {
    const [value, setValue] = useState(true);
    const handleInput = e => {
      setValue(e.detail.value);
...
}`,...(N=(E=g.parameters)==null?void 0:E.docs)==null?void 0:N.source}}};var _,O,J;f.parameters={...f.parameters,docs:{...(_=f.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => {
...
}`,...(J=(O=f.parameters)==null?void 0:O.docs)==null?void 0:J.source}}};var G,L,B;h.parameters={...h.parameters,docs:{...(G=h.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: args => {
    return html\`
            <f-div padding="x-large" height="100%">
                <f-code-editor .code=\${args.code} .language=\${args.language}></f-code-editor>
...
}`,...(k=(H=p.parameters)==null?void 0:H.docs)==null?void 0:k.source}}};const z=["Playground","Code","Title","Comments","CopyButton","ShowLineNumbers","State","Language","ReadOnly"],K=Object.freeze(Object.defineProperty({__proto__:null,Code:s,Comments:i,CopyButton:u,Language:h,Playground:d,ReadOnly:p,ShowLineNumbers:g,State:f,Title:c,__namedExportsOrder:z,default:W},Symbol.toStringTag,{value:"Module"}));export{s as C,K as F,h as L,d as P,p as R,g as S,c as T,i as a,u as b,f as c};
