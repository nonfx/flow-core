import{x as a}from"./lit-html-BulfDIla.js";import{f as i}from"./chunk-KRMY7ATX-ZvXBKWTq.js";import"./lit-element-3mBpJhh8.js";import{e as o,n as l}from"./ref-C9q2dBKz.js";import{d as Ae}from"./donwload-file-DfLomUDN.js";const c=o();function O(){return i.string.alpha(10)}function n(e=100,t=8){const d=[];for(let f=0;f<e;f++){const F={value:i.person.firstName(),align:"middle-left",template:function(){return a`<f-div gap="small" align="middle-left" width="100%" height="100%">
  ...
  name: "search-term"
}`,...(de=(ie=x.parameters)==null?void 0:ie.docs)==null?void 0:de.source}}};var oe,le,se;y.parameters={...y.parameters,docs:{...(oe=y.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => {
    const data = getFakeUsers(10, 5);
    return html\`
            <f-div gap="small" height="100%" overflow="scroll" gap="auto" width="100%">
...
}`,...(se=(le=y.parameters)==null?void 0:le.docs)==null?void 0:se.source}}};var ce,fe,me;$.parameters={...$.parameters,docs:{...(ce=$.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: () => {
