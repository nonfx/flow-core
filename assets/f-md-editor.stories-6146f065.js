import{x as r}from"./lit-html-b1a28dc3.js";import{n as $,e as I}from"./ref-a55570ea.js";const _=`# Heading 1
...
`,H={title:"@nonfx/flow-md-editor/f-md-editor",parameters:{controls:{hideNoControlsWarning:!0}}},n={render:e=>{const a=I(),o=function(y){console.log(y.detail.value)};return r`<f-div padding="x-large" height="100%">
  ...
  name: "@input"
}`,...(x=(w=d.parameters)==null?void 0:w.docs)==null?void 0:x.source}}};const T=["Playground","Value","Mode","InputEvent"],E=Object.freeze(Object.defineProperty({__proto__:null,InputEvent:d,Mode:i,Playground:n,Value:t,__namedExportsOrder:T,default:H},Symbol.toStringTag,{value:"Module"}));export{E as F,n as P};
