import{x as d}from"./lit-html-BulfDIla.js";import{g}from"./mock-data-utils-Xail7P4Q.js";import{f as e}from"./chunk-KRMY7ATX-ZvXBKWTq.js";import{n as p,e as u}from"./ref-C9q2dBKz.js";import"./directive-helpers-CWXDk_SO.js";import"./directive-CJw_OlP2.js";const y={title:"@nonfx/flow-dashboard/f-dashboard",argTypes:{field:{control:!1}}},l=()=>{const t=["p-azure","p-google","p-aws","p-hadoop","p-sonarcloud","p-snowflake","p-terraform","p-discord"],a=[],s=new Date;for(let r=0;r<10;r++)r%2===0?a.push({type:"timeseries",data:{data:g(s)},id:e.string.alpha(10),header(){const n=e.company.name(),i=e.lorem.sentences(3);return d`<f-div
                        align="middle-left"
                        height="hug-content"
                        padding="medium"
                        gap="medium"
