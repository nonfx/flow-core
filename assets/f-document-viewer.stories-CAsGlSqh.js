import{x as o}from"./lit-html-BulfDIla.js";import"./lit-element-3mBpJhh8.js";import{f}from"./chunk-KRMY7ATX-ZvXBKWTq.js";function p(e=2,n=2,u=!1){const t={};for(let i=0;i<e;i++)t[`${i+1}.`]=_(n,i+1,"heading"),u&&(t[`${i+1}.`].template=function(l){return o`
					<f-div gap="medium">
						<f-div gap="medium">
  ...
  name: "level-selector"
}`,...(J=(x=d.parameters)==null?void 0:x.docs)==null?void 0:J.source}}};const P=["Playground","Content","JumpLinks","CollapsibleJumpLinks","LevelSelector"],R=Object.freeze(Object.defineProperty({__proto__:null,CollapsibleJumpLinks:c,Content:r,JumpLinks:s,LevelSelector:d,Playground:a,__namedExportsOrder:P,default:z},Symbol.toStringTag,{value:"Module"}));export{r as C,R as F,s as J,d as L,a as P,c as a};
