import{x as o}from"./iframe-CCyKNv7C.js";const{useArgs:M,useState:l}=__STORYBOOK_MODULE_PREVIEW_API__,W={title:"@nonfx/flow-code-editor/f-code-editor",parameters:{controls:{hideNoControlsWarning:!0}}},d={render:e=>{const[n,t]=M(),r=function(a){console.log(a)};return o`<f-div padding="x-large" height="100%">
            <f-code-editor
                .code=${e.code}
                .language=${e.language}
                .state=${e.state}
