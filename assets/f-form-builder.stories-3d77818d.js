import{x as n}from"./lit-html-b1a28dc3.js";import"./lit-element-3bb9b17f.js";import{n as s,e as r}from"./ref-a55570ea.js";const h=()=>alert("test called"),b=()=>alert("Lucky function called"),v={type:"object",direction:"vertical",fieldSeparator:!1,label:{title:"Object level label",description:"following fields are used for demo purpose only"},fields:{paymentInfo:{type:"object",fields:{cardNumber:{type:"number",validationRules:[{name:"max-value",params:{max:5}}]},color:{type:"color",label:{title:"Color"}}}},hiddenField:{type:"hidden",qaId:"hiddenQA"},orgDetails:{type:"object",fields:{name:{qaId:"org",label:{title:"Org name",subTitle:n`<f-text size="small">
							<a href="#" @click=${b}>I'm Feeling Lucky</a>
				...
				>Testing&nbsp;<a href="#" @click=${h}> link</a>&nbsp;inside text.</f-text
...
}`,...(u=(c=o.parameters)==null?void 0:c.docs)==null?void 0:u.source}}};const I=["Playground"],S=Object.freeze(Object.defineProperty({__proto__:null,Playground:o,__namedExportsOrder:I,default:T},Symbol.toStringTag,{value:"Module"}));export{S as F,o as P};
