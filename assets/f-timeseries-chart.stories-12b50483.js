import{f as y}from"./index-1f53deeb.js";import{x as s}from"./lit-html-57bab4fd.js";import{n as h,e as d}from"./ref-8dc3593a.js";import{g as f}from"./mock-data-utils-f5f3c130.js";import"./directive-helpers-ef3e3cc7.js";import"./directive-12249aa5.js";const G={title:"@nonfx/flow-dashboard/f-timeseries-chart",parameters:{controls:{hideNoControlsWarning:!0}}};function C(e){const o=[{value:y.number.int({min:150,max:200}),color:"var(--color-danger-default)"},{value:y.number.int({min:50,max:100}),color:"var(--color-warning-default)"}];return{xLines:[{value:e[0].points[+(e[0].points.length/3).toFixed(0)].date,color:"yellow"},{value:e[0].points[+(e[0].points.length/2).toFixed(0)].date,color:"yellow"}],yLines:o}}const g={render:()=>{const e=f(new Date),{xLines:o,yLines:c}=C(e),t=d();for(let n=0;n<10;n++){const r=new Date;r.setMinutes(r.getMinutes()+15*(n+1))}const l={data:e,xAxis:{lines:o,tickConfig:{format:n=>`${n.getHours()}h${n.getMinutes()}m`,type:"interval",interval:{type:"minutes",every:5}}},yAxis:{lines:c,tickConfig:{format:n=>`#${n}`,type:"auto"}},legends:{disabled:!1,position:"bottom",template:({click:n,mouseEnter:r,mouseLeave:i})=>{const u=["i-area","i-bar","i-line"];return s`<f-div height="hug-content" gap="medium" align="middle-center">
            ...
            <f-timeseries-chart ${h(t)} .config=${l}></f-timeseries-chart>
        </f-div>`},name:"all-options"},p={render:()=>{const e=f(new Date),o=d(),c={data:e,xAxis:{tickConfig:{format:t=>`${t.getHours()}h${t.getMinutes()}m`,type:"interval",interval:{type:"minutes",every:5}}},yAxis:{tickConfig:{format:t=>`#${t}`,type:"auto"}},legends:{disabled:!1,position:"bottom",template:({click:t,mouseEnter:l,mouseLeave:m})=>{const n=["i-user","i-home","i-computer"];return s`<f-div height="hug-content" align="middle-center">
                        ${e.map((r,i)=>s`<f-div
            ...
            <f-timeseries-chart ${h(o)} .config=${c}></f-timeseries-chart>
        </f-div>`},name:"legends-template"},v={render:()=>{const e=f(new Date),{xLines:o,yLines:c}=C(e),t=d(),l={data:e,xAxis:{lines:o},yAxis:{lines:c}};return s`<f-div height="500px">
            <f-timeseries-chart ${h(t)} .config=${l}></f-timeseries-chart>
        </f-div>`},name:"x-&-y-lines"},x={render:()=>{const e=f(new Date),o=d(),c={data:e,tooltipTemplate:(t,l)=>s`<f-div
                    width="280px"
                    max-height="500px"
                    overflow="scroll"
                    direction="column"
            ...
            <f-timeseries-chart ${h(o)} .config=${c}></f-timeseries-chart>
        </f-div>`},name:"tooltip-template"},$={render:()=>{const e=f(new Date),o=d(),c={data:e,xAxis:{tickConfig:{format:t=>`${t.getHours()}h${t.getMinutes()}m`,type:"auto"}},yAxis:{tickConfig:{format:t=>`#${t}`,type:"auto"}}};return s`<f-div height="500px">
            <f-timeseries-chart ${h(o)} .config=${c}></f-timeseries-chart>
        </f-div>`},name:"tick-format"},D={render:()=>{const e=f(new Date),{xLines:o,yLines:c}=C(e),t=d(),l={data:e,xAxis:{lines:o},yAxis:{lines:c}},m=setInterval(()=>{const n=e.map(i=>i.points).flat();f(new Date(n[n.length-1].date+60*1e3),e.length,1).forEach((i,u)=>{const a=e[u];a==null||a.points.shift(),a==null||a.points.push(...i.points)}),t.value&&(t.value.config={...l})},1e3);return setTimeout(()=>{clearInterval(m)},6e4*60),s`<f-div height="500px">
            <f-timeseries-chart ${h(t)} .config=${l}></f-timeseries-chart>
  ...
  name: "realtime-data"
}`,...(X=(V=D.parameters)==null?void 0:V.docs)==null?void 0:X.source}}};const J=["AllOptions","CustomLegendTemplate","Lines","CustomTooltip","TickFormat","Realtime"];export{g as AllOptions,p as CustomLegendTemplate,x as CustomTooltip,v as Lines,D as Realtime,$ as TickFormat,J as __namedExportsOrder,G as default};
