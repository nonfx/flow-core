import{x as t}from"./lit-html-BulfDIla.js";const C={title:"@nonfx/flow-core/f-breadcrumb",parameters:{controls:{hideNoControlsWarning:!0}}},i={render:e=>{const n=a=>{console.log(a.detail.value)};return t` <f-div padding="small">
            <f-breadcrumb
                .crumbs=${e.crumbs}
                .variant=${e.variant}
                .size=${e.size}
