import{x as e}from"./lit-html-b1a28dc3.js";import{o as k}from"./unsafe-svg-e29b2cc0.js";import{n as F,e as _}from"./ref-a55570ea.js";const A=`<svg width="622" height="59" viewBox="0 0 622 59" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,W={title:"@nonfx/flow-core/f-progress-bar",parameters:{controls:{hideNoControlsWarning:!0}}},t={render:a=>{const r=_();return e`<f-div direction="row" padding="x-large" gap="medium"
            ><f-progress-bar
                ${F(r)}
                .value=${a.value}
                .variant=${a.variant}
        ...
        >`,name:"variant"},d={render:()=>{const a=["large","medium","small","x-small"];return e`${["block","curved","circle"].map(c=>e`<f-div direction="column" gap="medium">
                    ...
                    <f-divider></f-divider>
                </f-div>`)}`},name:"size"},o={render:()=>e`<f-div direction="column" gap="medium"
        ...
        >`,name:"width"};var f,v,p;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...
  argTypes: {
    ...
    state: {
      control: "select",
      options: ["default", "primary", "success", "warning", "danger", "custom, #0000FF", "custom, gray", "custom, #fff", "custom, white", "custom, black", "custom, #607B9F"]
    },
    width: {
      control: "select",
...
}`,...(p=(v=t.parameters)==null?void 0:v.docs)==null?void 0:p.source}}};var u,g,h;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:'{\n  render: () => html`<div class="align-center">${unsafeSVG(fProgressBarAnatomy)}</div>`,\n  name: "Anatomy"\n}',...(h=(g=i.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var w,x,$;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => {
    return html\`<f-div direction="row" padding="x-large" gap="medium"
            ><f-progress-bar value="30%" variant="curved" state="success"></f-progress-bar>
            <f-div width="hug-content"
  ...
  name: "value"
}`,...($=(x=n.parameters)==null?void 0:x.docs)==null?void 0:$.source}}};var b,V,C;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "variant"
}`,...(C=(V=s.parameters)==null?void 0:V.docs)==null?void 0:C.source}}};var z,y,H;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "size"
}`,...(H=(y=d.parameters)==null?void 0:y.docs)==null?void 0:H.source}}};var B,L,M;o.parameters={...o.parameters,docs:{...(B=o.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "state"
}`,...(M=(L=o.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};var S,Z,P;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => {
  ...
  name: "width"
}`,...(P=(Z=l.parameters)==null?void 0:Z.docs)==null?void 0:P.source}}};const O=["Playground","Anatomy","Value","Variant","Size","State","Width"],E=Object.freeze(Object.defineProperty({__proto__:null,Anatomy:i,Playground:t,Size:d,State:o,Value:n,Variant:s,Width:l,__namedExportsOrder:O,default:W},Symbol.toStringTag,{value:"Module"}));export{i as A,E as F,t as P,d as S,n as V,l as W,s as a,o as b};
