import{x as i}from"./lit-html-b1a28dc3.js";import{n as g,e as u}from"./ref-a55570ea.js";const p={title:"@nonfx/flow-lineage/f-lineage",parameters:{controls:{hideNoControlsWarning:!0}}},l=u(),h=e=>{const n=document.querySelector("#lineage-tooltip");n&&(n.innerHTML=e)},a={render:e=>{const n=t=>{console.log("Got ready event",t)},c=t=>{var o,r,d;t.detail.node.fNodeMeta,console.log(t==null?void 0:t.detail),(o=t.detail.node.fNodeMeta)!=null&&o.tabSections&&(Object.keys((r=t.detail.node.fNodeMeta)==null?void 0:r.tabSections),(d=t.detail.node.fNodeMeta)==null||d.tabSections)};return i`<f-div id="can-fullscreen" ${g(l)} height="100%">
...
}`,...(f=(m=a.parameters)==null?void 0:m.docs)==null?void 0:f.source}}};const v=["Playground"],y=Object.freeze(Object.defineProperty({__proto__:null,Playground:a,__namedExportsOrder:v,default:p},Symbol.toStringTag,{value:"Module"}));export{y as F,a as P};
