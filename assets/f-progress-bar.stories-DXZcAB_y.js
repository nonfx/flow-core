import{x as e}from"./lit-html-BulfDIla.js";import{o as k}from"./unsafe-svg-Bgti8cH4.js";import{n as F,e as _}from"./ref-C9q2dBKz.js";const A=`<svg width="622" height="59" viewBox="0 0 622 59" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,W={title:"@nonfx/flow-core/f-progress-bar",parameters:{controls:{hideNoControlsWarning:!0}}},t={render:r=>{const a=_();return e`<f-div direction="row" padding="x-large" gap="medium"
            ><f-progress-bar
                ${F(a)}
                .value=${r.value}
                .variant=${r.variant}
            ...
            >${["block","curved","circle"].map(a=>e`<f-div direction="row" padding="x-large" gap="medium"
                        ><f-progress-bar value="30%" .variant=${a}></f-progress-bar>
                        <f-div width="hug-content"
                            ><f-text variant="para" size="small">variant="${a}"</f-text></f-div
                        >
                    </f-div>`)}</f-div
        >`,name:"variant"},o={render:()=>{const r=["large","medium","small","x-small"];return e`${["block","curved","circle"].map(c=>e`<f-div direction="column" gap="medium">
                    <f-div padding="medium"><f-text>variant="${c}"</f-text></f-div>
                    ${r.map(m=>e`<f-div direction="row" align="middle-left" padding="x-large" gap="medium"
                                ><f-progress-bar
                                    value="30%"
                                    .size=${m}
                                    .variant=${c}
            ...
            >${["default","primary","success","danger","warning","custom,#fff"].map(a=>e`<f-div direction="row" padding="x-large" gap="medium"
                        ><f-progress-bar value="30%" .state=${a} variant="curved"></f-progress-bar>
                        <f-div width="20%"><f-text variant="para" size="small">state="${a}"</f-text></f-div>
                    </f-div>`)}</f-div
        >`,name:"state"},l={render:()=>e`<f-div direction="column" gap="medium"
            >${["fill-container","300px"].map(a=>e`<f-div direction="row" padding="x-large" gap="medium"
                        ><f-progress-bar
                            value="30%"
                            .width=${a}
                            variant="curved"
                            state="primary"
                        ></f-progress-bar>
                        <f-div width="20%"><f-text variant="para" size="small">width="${a}"</f-text></f-div>
                    </f-div>`)}</f-div
  ...
  name: "width"
}`,...(P=(Z=l.parameters)==null?void 0:Z.docs)==null?void 0:P.source}}};const O=["Playground","Anatomy","Value","Variant","Size","State","Width"],E=Object.freeze(Object.defineProperty({__proto__:null,Anatomy:i,Playground:t,Size:o,State:d,Value:n,Variant:s,Width:l,__namedExportsOrder:O,default:W},Symbol.toStringTag,{value:"Module"}));export{i as A,E as F,t as P,o as S,n as V,l as W,s as a,d as b};
