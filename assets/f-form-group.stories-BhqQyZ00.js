import{x as a}from"./lit-html-BulfDIla.js";import"./unsafe-svg-Bgti8cH4.js";const A={title:"@nonfx/flow-core/f-form-group",parameters:{controls:{hideNoControlsWarning:!0}}},e={render:i=>a`
        <f-form>
            <f-form-group
                data-qa-id="testQaId"
                variant=${i.variant}
  ...
  render: args => html\`<f-form ?separator=\${true}>
    ...
    description: "This is a description"
        ...
        ></f-form> \`,
  name: "Flags"
}`,...(z=(R=f.parameters)==null?void 0:R.docs)==null?void 0:z.source}}};const B=["Playground","Variant","Direction","Gap","Collapse","Flags"],G=Object.freeze(Object.defineProperty({__proto__:null,Collapse:t,Direction:l,Flags:f,Gap:r,Playground:e,Variant:o,__namedExportsOrder:B,default:A},Symbol.toStringTag,{value:"Module"}));export{t as C,l as D,G as F,r as G,e as P,o as V,f as a};
