import{x as s}from"./lit-html-b1a28dc3.js";const oe={title:"@nonfx/flow-core/f-search",parameters:{controls:{hideNoControlsWarning:!0}}},g={render:e=>{const i=t=>{console.log(t.detail)},n=t=>{console.log(t.detail)};return s`
            <f-div padding="large">
                <f-search
      ...
      >`)}
        ...
        `},name:"variant"},u={render:()=>{const e=["fill","outline","transparent"],i="",n=t=>{console.log(t.detail.value)};return s`
            <f-div width="100%" align="middle-center" padding="large" gap="medium">
                ${e.map(t=>s`<f-div>
          <f-search
            value=${i}
      ...
      >`)}
        ...
        `,name:"value"},c={render:()=>s`
            <f-div width="100%" align="middle-center" padding="large">
                ...
                ></f-div
            >
        `,name:"placeholder"},p={render:()=>{const e=["small","medium"],i="",n=t=>{console.log(t.detail.value)};return s`
      ...
      >`)}
        ...
        `},name:"size"},S={render:()=>{const e=[["default","primary","success"],["danger","warning","default"]],i="",n=t=>{console.log(t.detail.value)};return s`
            <f-div direction="column" gap="medium">
                ${e.map(t=>s` <f-div align="middle-center" padding="large" gap="medium">
                            ${t.map(o=>s`<f-div
                                        ><f-search
                                            value=${i}
                                            @input=${n}
        ...
        `},name:"state"},f={render:()=>{const e="jane",i=a=>{console.log("in input",a)};return s`
            <f-div width="100%" align="middle-center" padding="large" gap="medium">
                ...
                <f-div align="middle-center">
                    <f-search
                        ...
                        @input=${i}
                        size="medium"
                        .result=${[{value:{firstname:"henry",lastname:"jane"},template:function(a){return s`<f-div gap="medium" direction="column"
                        ><f-text inline highlight=${a}
                            >${this.value.firstname} ${this.value.lastname}</f-text
                        ><f-text inline highlight=${a}>subtitle</f-text></f-div
                    >`},toString:function(){return this.value.firstname+" "+this.value.lastname}},{value:{firstname:"tony",lastname:"stark"},template:function(a){return s`<f-div gap="medium" direction="column"
                        ><f-text inline highlight=${a}
                            >${this.value.firstname} ${this.value.lastname}</f-text
                        ><f-text inline highlight=${a}>subtitle</f-text></f-div
        ...
        `,name:"scope"},v={render:()=>s`
            <f-div width="100%" align="middle-center" padding="large">
                ...
                ></f-div
            >
        `,name:"selected-scope"},h={render:()=>s`
            <f-div width="100%" align="middle-center" padding="large">
                <f-div width="80%" align="middle-center">
                    <f-search
                        value=${""}
                ...
                ></f-div
            >
        `,name:"result-max-height"},$={render:()=>s`
            <f-div width="100%" align="middle-center" padding="large">
                <f-div width="80%" align="middle-center">
                    <f-search
                        value=${""}
                ...
                ></f-div
            >
        `,name:"result-when"},x={render:()=>{const e="",i=n=>{console.log(n.detail.value)};return s`
            <f-div width="100%" align="top-center" padding="large" gap="medium">
                ${[0,1,2,3].map(n=>s`<f-div>
          <f-search
            value=${e}
            placeholder="Write here"
            @input=${i}
  ...
  name: "result"
}`,...(N=(U=f.parameters)==null?void 0:U.docs)==null?void 0:N.source}}};var A,B,G;m.parameters={...m.parameters,docs:{...(A=m.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => {
    const value = "";
    const handleValue = (e: CustomEvent) => {
      console.log(e.detail.value);
  ...
  name: "scope"
}`,...(G=(B=m.parameters)==null?void 0:B.docs)==null?void 0:G.source}}};var J,K,Q;v.parameters={...v.parameters,docs:{...(J=v.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => {
    const value = "";
    const handleValue = (e: CustomEvent) => {
      console.log(e.detail.value);
  ...
  name: "selected-scope"
}`,...(Q=(K=v.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};var X,Y,Z;h.parameters={...h.parameters,docs:{...(X=h.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => {
    const value = "";
    const handleValue = (e: CustomEvent) => {
      console.log(e.detail.value);
  ...
  name: "Flags"
}`,...(ae=(se=x.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};const le=["Playground","Variant","Category","Value","Placeholder","Size","State","Result","Scope","selectedScope","resultMaxHeight","resultWhen","Flags"],re=Object.freeze(Object.defineProperty({__proto__:null,Category:u,Flags:x,Placeholder:c,Playground:g,Result:f,Scope:m,Size:p,State:S,Value:d,Variant:r,__namedExportsOrder:le,default:oe,resultMaxHeight:h,resultWhen:$,selectedScope:v},Symbol.toStringTag,{value:"Module"}));export{u as C,re as F,g as P,f as R,p as S,r as V,d as a,c as b,S as c,m as d,x as e};
