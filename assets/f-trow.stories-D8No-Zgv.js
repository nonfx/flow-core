import{x as e,n as j,e as D}from"./iframe-C5Wc31tw.js";const F={title:"@nonfx/flow-table/f-trow",parameters:{controls:{hideNoControlsWarning:!0}}},a={render:t=>{const l=r=>{console.log("selected rows",r.detail)},n=r=>{console.log("clicked",r)};return e`
