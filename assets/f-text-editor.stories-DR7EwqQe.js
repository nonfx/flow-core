import{x as t,n as E,e as P}from"./iframe-C5Wc31tw.js";const R={title:"@nonfx/flow-text-editor/f-text-editor",parameters:{controls:{hideNoControlsWarning:!0}}},n={render:e=>{const s=function(l){console.log(l)};return t`<f-div height="100%">
            <f-text-editor
