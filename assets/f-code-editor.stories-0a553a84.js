import{x as o}from"./lit-html-b1a28dc3.js";const{useArgs:M,useState:r}=__STORYBOOK_MODULE_CLIENT_API__,z={title:"@nonfx/flow-code-editor/f-code-editor",parameters:{controls:{hideNoControlsWarning:!0}}},d={render:e=>{M();const n=function(t){console.log(t)};return o`<f-div padding="x-large" height="100%">
            <f-code-editor
                .code=${e.code}
                .language=${e.language}
                .state=${e.state}
