import{x as i}from"./iframe-BdnCiKt2.js";const oe={title:"@nonfx/flow-core/f-search",parameters:{controls:{hideNoControlsWarning:!0}}},g={render:e=>{const s=t=>{console.log(t.detail)},n=t=>{console.log(t.detail)};return i`
            <f-div padding="large">
                <f-search
