import{x as d}from"./iframe-C5Wc31tw.js";const{useArgs:oe,useEffect:ue,useState:o}=__STORYBOOK_MODULE_PREVIEW_API__,re={title:"@nonfx/flow-core/f-emoji-picker",parameters:{controls:{hideNoControlsWarning:!0}}},r={render:e=>{const[n,t]=oe(),i=l=>{t({value:l.detail.value})};return d`
