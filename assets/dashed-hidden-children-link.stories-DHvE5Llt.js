import{x as i}from"./lit-html-BulfDIla.js";import{c as r,n as a}from"./node-templates-B52zEtIB.js";import{n as l}from"./nodes-Dy-e1dV2.js";const g={title:"@nonfx/flow-lineage/Debug/dashed-hidden-children-link",argTypes:{"node-template":{control:!1},"children-node-template":{control:!1}}},s=[{from:"node1",to:"node2"},{from:"node2",to:"node5"},{to:"node3",from:"node5"},{from:"node6",to:"node5"},{from:"node5",to:"node4"},{from:"node4child1",to:"node5child2"},{from:"node4child1",to:"node5child1"},{from:"node1child1",to:"node5child6"}],h=n=>i`
        <f-lineage
            ...
            stagger-load="1"
        ></f-lineage>
    `,e=h.bind({});e.args={"node-template":a,"children-node-template":r};var o,d,t;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`(args: any) => {
  return html\`
        <f-lineage
            direction="horizontal"
            padding="16"
