import{x as t}from"./lit-html-BulfDIla.js";import{n as E,e as P}from"./ref-C9q2dBKz.js";const R={title:"@nonfx/flow-text-editor/f-text-editor",parameters:{controls:{hideNoControlsWarning:!0}}},n={render:e=>{const s=function(l){console.log(l)};return t`<f-div height="100%">
            <f-text-editor
  ...
  name: "@input"
}`,...(k=(S=d.parameters)==null?void 0:S.docs)==null?void 0:k.source}}};const _=["Playground","Value","Placeholder","ReadOnly","ToolBar","InputEvent"],N=Object.freeze(Object.defineProperty({__proto__:null,InputEvent:d,Placeholder:i,Playground:n,ReadOnly:o,ToolBar:a,Value:r,__namedExportsOrder:_,default:R},Symbol.toStringTag,{value:"Module"}));export{N as F,n as P};
