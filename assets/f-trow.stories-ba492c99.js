import{x as e}from"./lit-html-b1a28dc3.js";import{n as j,e as D}from"./ref-a55570ea.js";const F={title:"@nonfx/flow-table/f-trow",parameters:{controls:{hideNoControlsWarning:!0}}},a={render:t=>{const l=r=>{console.log("selected rows",r.detail)},n=r=>{console.log("clicked",r)};return e`
  ...
  name: "@toggle-row"
}`,...(J=(A=m.parameters)==null?void 0:A.docs)==null?void 0:J.source}}};const I=["Playground","Anatomy","State","Open","Selected","ExpandIconPosition","SelectedRow","ToggleRow"],q=Object.freeze(Object.defineProperty({__proto__:null,Anatomy:i,ExpandIconPosition:f,Open:d,Playground:a,Selected:s,SelectedRow:c,State:o,ToggleRow:m,__namedExportsOrder:I,default:F},Symbol.toStringTag,{value:"Module"}));export{i as A,f as E,q as F,d as O,a as P,o as S,m as T,s as a,c as b};
