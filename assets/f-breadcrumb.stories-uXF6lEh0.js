import{x as t}from"./iframe-D6om2Bsl.js";const C={title:"@nonfx/flow-core/f-breadcrumb",parameters:{controls:{hideNoControlsWarning:!0}}},i={render:e=>{const n=a=>{console.log(a.detail.value)};return t` <f-div padding="small">
            <f-breadcrumb
                .crumbs=${e.crumbs}
                .variant=${e.variant}
                .size=${e.size}
