import{x as e}from"./iframe-BdnCiKt2.js";const P={title:"@nonfx/flow-core/f-countdown",parameters:{controls:{hideNoControlsWarning:!0}}},a={render:n=>e` <f-div padding="small">
            <f-countdown
                .state=${n.state}
                .size=${n.size}
                .category=${n.category}
