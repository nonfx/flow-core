import{x as o}from"./lit-html-57bab4fd.js";const{useArgs:M,useState:r}=__STORYBOOK_MODULE_CLIENT_API__,z={title:"@nonfx/flow-code-editor/f-code-editor",parameters:{controls:{hideNoControlsWarning:!0}}},d={render:e=>{M();const n=function(t){console.log(t)};return o`<f-div padding="x-large" height="100%">
            <f-code-editor
                .code=${e.code}
                .language=${e.language}
                .state=${e.state}
...
}`,...(y=(x=s.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var w,T,S;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => {
...
}`,...(S=(T=c.parameters)==null?void 0:T.docs)==null?void 0:S.source}}};var I,A,R;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => {
...
}`,...(E=(N=g.parameters)==null?void 0:N.docs)==null?void 0:E.source}}};var O,_,J;f.parameters={...f.parameters,docs:{...(O=f.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => {
...
}`,...(J=(_=f.parameters)==null?void 0:_.docs)==null?void 0:J.source}}};var L,G,B;h.parameters={...h.parameters,docs:{...(L=h.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: args => {
    return html\`
            <f-div padding="x-large" height="100%">
                <f-code-editor .code=\${args.code} .language=\${args.language}></f-code-editor>
...
}`,...(B=(G=h.parameters)==null?void 0:G.docs)==null?void 0:B.source}}};var F,H,k;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: args => {
...
}`,...(k=(H=p.parameters)==null?void 0:H.docs)==null?void 0:k.source}}};const D=["Playground","Code","Title","Comments","CopyButton","ShowLineNumbers","State","Language","ReadOnly"],W=Object.freeze(Object.defineProperty({__proto__:null,Code:s,Comments:i,CopyButton:u,Language:h,Playground:d,ReadOnly:p,ShowLineNumbers:g,State:f,Title:c,__namedExportsOrder:D,default:z},Symbol.toStringTag,{value:"Module"}));export{s as C,W as F,h as L,d as P,p as R,g as S,c as T,i as a,u as b,f as c};
